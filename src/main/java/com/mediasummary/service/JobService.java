...
public class JobService {
    ...
    private Summaries requestSummaries(String transcription, int maxChars) throws IOException {
        ...
        String prompt = "Analiza esta transcripcion y responde en espanol, nunca en ingles, "
                ...
                + "El campo 'speaker' es como esa persona aparecera identificada en el correo, "
                + "que alguien va a leer para redactar una minuta sin haber estado presente. "
                + "Nunca escribas ahi una letra ni 'Participante A': no le dice nada a quien lee.\n"
                + "Si lograste identificar el nombre, pon el nombre. Si no, pon una descripcion "
                + "breve del papel que cumple esa voz, deducida de lo que efectivamente dijo: "
                + "'Quien lidera la reunion', 'Quien revisa las fichas tecnicas', 'Quien gestiona "
                + "la preventa'. Maximo ocho palabras, y que cada descripcion sea distinta de las "
                + "demas para poder diferenciar a las personas entre si.\n"
                + "Nunca inventes un nombre ni lo deduzcas del tema de conversacion: la "
                + "descripcion del papel es preferible a un nombre equivocado.\n"
